...
\end{equation}
where $E$ is the energy percentage that BLE uses, and if we take the reduced messaging rate of $85.07\%$, we get a new BLE power consumption
\begin{equation}
    P_{BLE, New} = (1-0.8507)\times P_{BLE}
\end{equation}
\begin{equation}
    P_{BLE, New} = (1-0.8507) \times E \times P_{total}
\end{equation}
...
\end{equation}
\begin{equation}
    P_{total, new} = (1-E)\times P_{total}+ (1-0.8507) \times E \times P_{total}
\end{equation}
\begin{equation}
    P_{total, new} = P_{total}[(1-E)+ (1-0.8507) \times E]
\end{equation}
\begin{equation}
    P_{total, new} = P_{total}(1-0.8507E)
\end{equation}
Subsequently, the formula for computing the new battery life becomes
\begin{equation}
    L_{new} = \frac{B}{P_{total, new}} = \frac{B}{ P_{total}(1-0.8507E)}
\end{equation}
